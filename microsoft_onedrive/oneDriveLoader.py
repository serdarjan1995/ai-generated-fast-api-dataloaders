...
class OneDriveReader(BaseReader):
    ...
    def _get_items_in_drive_with_maxretries(
        ...
        userprincipalname: str value indicating the userprincipalname(normally organization provided email id) whose onedrive needs to be accessed. Mandatory for App authentication scenarios.
        ...
        while retries < max_retries:
            ...
            # Check for Rate limit error, this can happen if you query endpoint recursively
    ...
    def _connect_download_and_return_metadata(
        ...
        - userprincipalname (str): The userprincipalname(normally organization provided email id) whose onedrive needs to be accessed. Mandatory for App authentication scenarios.
