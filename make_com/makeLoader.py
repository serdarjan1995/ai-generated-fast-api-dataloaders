...
@app.post("/pass-response-to-webhook/",
          summary="Pass response to Make.com webhook",
          description="Pass a response object to a specified Make.com webhook url.")
async def pass_response_to_webhook(webhook_url: str = Query(..., description="Webhook URL to which the response will be sent"),
                               response: ResponseModel = Body(..., description="Response object containing the response and source nodes"),
