...
from mangopps_guides_reader import MangoppsGuidesReader
...
@app.post('/load_data/', response_model=List[Document], summary='Load MangoppsGuides data',
...
@app.get('/crawl_urls/', summary='Crawl URLs from a MangoppsGuides domain',
